...
const SOCIAL_LINKS = { github: 'https://github.com/ManasiSonje', linkedin: 'https://www.linkedin.com/in/manasi-sonje/', email: 'sonjemanasi@gmail.com', codechef: 'https://www.codechef.com/users/sonjem25', leetcode: 'https://leetcode.com/u/Manasi_Sonje/' }
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <main className="container mx-auto px-4 relative z-10">
        ...
        <div className="reveal"><AchievementsSection /></div>
        <div className="reveal"><ContactSection formData={formData} setFormData={setFormData} handleSubmit={handleSubmit} formStatus={formStatus} /></div>
      </main>
    </div>
  )
}
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 xl:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left animate-fade-in-up">
            ...
            <p className="text-lg lg:text-xl text-slate-400 mb-4 font-light">
              Full Stack Developer <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent font-semibold">&</span> Problem Solver
            </p>
            <p className="text-slate-400 mb-6 max-w-md mx-auto lg:mx-0 leading-relaxed text-sm lg:text-base">
              Building innovative web applications with modern technologies. Passionate about problem-solving and creating meaningful digital experiences.
            </p>
          ...
          <div className="flex-none animate-fade-in" style={{ animationDelay: '100ms' }}>
            <div className="relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-blue-500/15 to-purple-500/15 rounded-3xl blur-xl" />
              <div className="relative w-64 h-80 sm:w-72 sm:h-96 lg:w-80 lg:h-[28rem] xl:w-96 xl:h-[32rem] rounded-3xl overflow-hidden shadow-[0_15px_50px_-12px_rgba(59,130,246,0.2)]">
...
<div className="flex flex-col gap-4 items-center lg:items-start">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-3 justify-center">
                <a href={SOCIAL_LINKS.codechef} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1 group">
                  <div className="w-12 h-12 rounded-full bg-slate-800/80 border border-blue-500/20 hover:border-blue-400 hover:bg-slate-800 flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-blue-500/20">
                    <svg className="w-6 h-6 text-slate-200" viewBox="0 0 24 24" fill="currentColor"><path d="M21.976 24h-4.35c-.45 0-.81-.3-.93-.75l-.98-4.5H8.25l-.98 4.5c-.12.45-.48.75-.93.75H.024l7.74-19.5c.24-.6 1.22-.6 1.46 0L16.26 24h4.35c.45 0 .81.3.93.75l.98 4.5h.27c.45 0 .81.3.93.75h.24c.6 0 1.04-.6.81-1.17l-6.12-14.25c-.24-.6-1.22-.6-1.46 0l-6.12 14.25c-.24.57.21 1.17.81 1.17h3.63l-.81 3.75h-3.51c-.6 0-1.04.6-.81 1.17l1.86 4.5c.24.6 1.22.6 1.46 0l1.86-4.5c.24-.57-.21-1.17-.81-1.17h-2.01l.81-3.75h5.22l.81 3.75h-1.08c-.6 0-1.04.6-.81 1.17l1.86 4.5c.24.6 1.22.6 1.46 0l1.86-4.5c.23-.57-.22-1.17-.82-1.17z"/></svg>
                  </div>
                  <span className="text-xs text-slate-400 group-hover:text-blue-400 transition-colors">CodeChef</span>
                </a>
                <a href={SOCIAL_LINKS.leetcode} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1 group">
                  <div className="w-12 h-12 rounded-full bg-slate-800/80 border border-blue-500/20 hover:border-blue-400 hover:bg-slate-800 flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-blue-500/20">
                    <svg className="w-6 h-6 text-slate-200" viewBox="0 0 24 24" fill="currentColor"><path d="M19.5 10c-2.5 0-4.5 2-4.5 4.5s2 4.5 4.5 4.5 4.5-2 4.5-4.5-2-4.5-4.5-4.5zm0 7c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5zM4.5 10C2 10 0 12 0 14.5S2 19 4.5 19 9 17 9 14.5 7 10 4.5 10zm0 7c-1.38 0-2.5-1.12-2.5-2.5S3.12 12 4.5 12 7 13.12 7 14.5 5.88 17 4.5 17zm9-11c-2.5 0-4.5 2-4.5 4.5s2 4.5 4.5 4.5 4.5-2 4.5-4.5-2-4.5-4.5-4.5zm0 7c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>
                  </div>
                  <span className="text-xs text-slate-400 group-hover:text-blue-400 transition-colors">LeetCode</span>
                </a>
              </div>
            </div>
          </div>
